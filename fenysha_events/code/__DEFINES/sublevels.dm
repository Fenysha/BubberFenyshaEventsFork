...
#define RW_SUBLEVEL_INITIALIZE_BUDGET  1024
#define RW_SUBLEVEL_POPULATE_BUDGET    320
#define RW_SUBLEVEL_LIGHTING_BUDGET    1024
#define RW_SUBLEVEL_DAYLIGHT_BUDGET    1024
#define RW_SUBLEVEL_SMOOTH_BUDGET      320

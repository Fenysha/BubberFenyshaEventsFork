...
/datum/weather/fog/generate_overlay_cache()
	...
	for(var/offset in 0 to SSmapping.max_plane_offset)
		var/mutable_appearance/new_weather_overlay = mutable_appearance('fenysha_events/icons/area/weather_overlays.dmi', weather_state, overlay_layer, plane = WEATHER_PLANE, offset_const = offset)
